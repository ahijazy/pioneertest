...
#
# This file is part of pioneertest
#
...
#'
#' @details
#' This function executes the pioneertest Study.
#' 
  ...
  if(createValidationPackage){
      ...
      tryCatch({
        ...
        createValidationPackage(
          devPackageName = 'pioneertest',
          devDatabaseName = databaseDetails$cdmDatabaseName,
          analysisLocation = outputFolder,
          analysisIds = analysesToValidate,
          outputFolder = outputFolder,
          validationPackageName = 'pioneertestValidation',
          description = 'validating models in pioneertest',
          createdBy = 'anonymous',
